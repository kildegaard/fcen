...
tree2 = DecisionTreeClassifier(min_samples_leaf=10)  # ! Primer diferencia
...
posic = clf.cv_results_['rank_test_score'][0]  # ! Segunda dif. En v1 está sin comentar y [5]
profposta = p_grid['max_depth'][posic - 1]  # ! 3ra dif, en v1 está comentado
# profposta = 4 #! 4ta dif, en v1 está sin comentar
print('Profundidad optima: ', profposta)

treeoptimo = DecisionTreeClassifier(max_depth=profposta, min_samples_leaf=10)  # ! 5ta dif, acá decía =3
