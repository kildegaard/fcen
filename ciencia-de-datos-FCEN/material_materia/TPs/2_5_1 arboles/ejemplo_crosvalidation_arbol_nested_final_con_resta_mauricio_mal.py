...
for outer in range(K):
    ...
    plt.scatter(df['x'][df['z']==1], df['y'][df['z']==1],s=20,c='red')
    plt.scatter(df['x'][df['z']==0], df['y'][df['z']==0],s=20,c='blue')
    plt.scatter(df2['x'], df2['y'],s=20,c='black', marker='x')
